    ...
    <div className="bg-slate-100 min-h-screen p-10">
      <div className="max-w-lg mx-auto text-center">
        ...
        <div className="flex items-center justify-between mt-10">
          <div>
            <button className="bg-stone-300 px-5 py-1.5 font-semibold text-xl hover:bg-stone-400 rounded-lg flex items-center justify-center">
              <span>
                <svg
          ...
          <div>
            <button className="bg-sky-300 px-5 py-1.5 font-semibold text-xl hover:bg-sky-400 rounded-lg flex items-center justify-center">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
          ...
          <div>
            <button className="bg-zinc-600 px-5 py-1.5 font-semibold text-white text-xl hover:bg-zinc-700 rounded-lg flex items-center justify-center">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
