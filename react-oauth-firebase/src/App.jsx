  ...
  return (
    <div className="bg-slate-100 min-h-screen p-10">
      <div className="max-w-lg mx-auto text-center">
        <h1 className="text-2xl font-bold ">React OAuth Firebase 🔥</h1>

        <h2 className="mt-5 font-semibold text-lg">Login Using : </h2>
        <div className="flex items-center justify-between mt-16">
          <div>
            <button
              onClick={googleLogin}
              className="bg-stone-300 px-5 py-1.5 font-semibold text-xl hover:bg-stone-400 rounded-lg flex items-center justify-center"
            >
              <span>
                <svg
          ...
          <div>
            <button
              ...
              className="bg-blue-300 px-5 py-1.5 font-semibold text-xl hover:bg-blue-400 rounded-lg flex items-center justify-center"
            >
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <button
              onClick={githubLogin}
              className="bg-zinc-600 px-5 py-1.5 font-semibold text-white text-xl hover:bg-zinc-700 rounded-lg flex items-center justify-center"
            >
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        {user && (
          <div className="mt-14 flex items-center space-x-5 justify-center">
            {user.providerData.map((provider) => {
              if (provider.providerId === "google.com") {
                return (
                  <div key={provider.uid}>
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="30"
